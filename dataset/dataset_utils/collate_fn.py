...
def registration_collate_fn_stack_mode(
    ...
    # 1) Drop samples where __getitem__ returned None
    ...
    # image T
    collated_dict['image'] = torch.stack(collated_dict.pop('image')).permute(0, 3, 1, 2).contiguous()  # [B, 1, H, W]
    ...
    collated_dict['BEV_pointmap'] = torch.stack(collated_dict.pop('BEV_pointmap')).contiguous()  # [B, 5, H, W]
